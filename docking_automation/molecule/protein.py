...
from docking_automation.molecule.protein_events import ProteinRegistered, ProteinPathUpdated
...
class Protein:
    ...
    def with_new_path(self, new_path: str|Path) -> 'Protein':
        ...
        new_protein._register_domain_event(ProteinPathUpdated(
            protein_id=self.id,
            old_path=str(old_path),
            new_path=str(new_protein.path)
        ))
    ...
    def create(cls, path: str|Path, id: Optional[str] = None) -> 'Protein':
        ...
        protein._register_domain_event(ProteinRegistered(
