...
| Phase 3 ext | 中規模 (100×100) | 10,000 | 216.3s (40.8 pairs/s, 観測 88.25% / 実質 **~98%** success; 1,095 failed の内訳: 800 = Dask並列+unidock競合 bug で直接呼べば成功、295 = v1 GPU #144 破綻で v2 なら解消) |
